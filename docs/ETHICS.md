...
A core motivation of BLUFF is addressing the inequity in disinformation detection resources. We explicitly measure and report the performance gap between big-head (20) and long-tail (59) languages to ensure that progress in multilingual AI does not solely benefit already well-resourced languages.
